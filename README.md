...
ARM Template to provision a Ubuntu VM complete with Visual Studio Code, Truffle and TestRPC for Ethereum blockchain development. The solitdity and material icon extension are installed as well for easy blcokchain development.
